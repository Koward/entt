...
struct is_view<basic_view<Entity, Component...>>: std::true_type {};
...
template<typename Entity, typename... Component, typename... Override>
struct unpack_type<basic_view<Entity, Component...>, type_list<Override...>> {
    using ro = type_list_cat_t<typename unpack_type<Component, type_list<Override...>>::ro...>;
    using rw = type_list_cat_t<typename unpack_type<Component, type_list<Override...>>::rw...>;
};

template<typename Entity, typename... Component, typename... Override>
struct unpack_type<const basic_view<Entity, Component...>, type_list<Override...>>
    : unpack_type<basic_view<Entity, Component...>, type_list<Override...>>
{};
